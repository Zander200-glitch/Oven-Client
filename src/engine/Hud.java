...
import static game.Crafter.getIngameNameDisplay;
...
public class Hud {
    ...
    public static void createHud(){
        ...
        createCrossHair();
        versionInfoText = createCustomHudText(getIngameNameDisplay(), 1,1,1);
        versionInfoTextShadow = createCustomHudText(getIngameNameDisplay(), 0,0,0);
        createPlayerMesh();
